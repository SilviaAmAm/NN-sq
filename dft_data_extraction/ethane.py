...
filenames_molpro = glob.glob("/panfs/panasas01/chem/sa16246/calculations/ethane_cn_dft/cn_ethane_molpro_outputs/*.out")
...
f = h5py.File("../data_sets/ethane_cn_dft.hdf5", "w")
