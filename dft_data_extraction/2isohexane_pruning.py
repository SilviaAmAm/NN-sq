...
data = h5py.File("../data_sets/2isohexane_cn_dft.hdf5", "r")
...
for frame in range(all_traj_idx.shape[0]):
    if ch_dist_cn[frame] >= 2.0 and ch_dist_alk[frame] >= 2.0:
...
# f = h5py.File("../data_sets/2isohexane_cn_dft_pruned.hdf5", "w")
#
