...
filenames_molpro = glob.glob("/panfs/panasas01/chem/sa16246/calculations/isobutane_cn_dft/cn_isobutane_molpro_outputs/*.out")
...
f = h5py.File("../data_sets/isobutane_cn_dft.hdf5", "w")
