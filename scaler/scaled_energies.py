...
zs_for_scaler_long = list(zs_methane) + list(zs_isopent) + list(zs_2hex) + list(zs_3hex) + list(zs_dimer)
concat_ene = np.concatenate((ene_methane, ene_isopent, ene_2hex, ene_3hex, ene_dimer))
