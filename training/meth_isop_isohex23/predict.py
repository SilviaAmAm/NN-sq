...
np.savez("sorted_predictions_right_model.npz", pred_methane, concat_ene_scaled[pred_idx_methane], pred_isopentane, concat_ene_scaled[pred_idx_isopentane], pred_2isohex, concat_ene_scaled[pred_idx_2isohex], pred_3isohex, concat_ene_scaled[pred_idx_3isohex], pred_squal, concat_ene_scaled[pred_idx_squal])
