...
# Generate estimator
estimator = ARMP(iterations=822, l1_reg=1.7465959510257397e-05, l2_reg=6.690500063362741e-06, learning_rate=0.0008983333675453145, representation_name='acsf',
                 representation_params=acsf_params, tensorboard=True, store_frequency=10, hidden_layer_sizes=(70,55,), batch_size=69)
