...
np.savez("sorted_predictions_right_model.npz", pred_methane, concat_ene_scaled[pred_idx_methane], pred_isopentane, concat_ene_scaled[pred_idx_isopentane], pred_squal, concat_ene_scaled[pred_idx_squal])
