...
def find_abstracted_h(xyz, h_idx, h_type, c_idx):
...
path = "/Volumes/Transcend/data_sets/CN_isobutane/isobutaneCN"
...
h_type = [(2, 1), (3, 1), (4, 1), (5, 3), (8, 1), (9, 1), (10, 1), (11, 1), (12, 1), (13, 1)]
...
for tr in unique_traj:
    ...
    is_hnc = check_hnc(xyz_last, h_idx, 15)
    hnc_abstraction.append(is_hnc)
    if is_hnc:
        continue

    abstraction_type.append(find_abstracted_h(xyz_last, h_idx, h_type, 14))

    ene_reactants.append(ene_traj[400:600])
    ene_prods.append(ene_traj[-200:])
...
print("There are %i samples after pruning." % len(x_p2))
...
plt.savefig("../images/isobutane_cn_pm6.png", dpi=200)
plt.show()


# Saving Pruned PM6 data
# f = h5py.File("../data_sets/isobutane_cn_pm6.hdf5", "w")
#
