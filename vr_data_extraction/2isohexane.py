...
path = "/Volumes/Transcend/data_sets/CN_2_isohexane/2IsohexaneCN_pm6"
...
h_type = [(2,3), (5,1), (6,1), (7,1), (8,2), (10,2), (11,2), (13,2), (14,1), (15,1), (16,1), (17,1), (18,1), (19,1)]
...
print("There are %i samples after the 1st round of pruning." % x_p2[-1])
...
# plt.savefig("../images/2isohexane_vr_pruned.png", dpi=200)
plt.show()

# Saving Pruned PM6 data
# f = h5py.File("../data_sets/2isohexane_cn_pm6_pruned.hdf5", "w")
#
