...
path = "/Volumes/Transcend/data_sets/CN_ethane/ethaneCN"
...
h_type = [(1, 1), (2, 1), (4, 1), (5, 1), (6, 1), (7, 1),]
...
for tr in unique_traj:
    ...
    is_hnc = check_hnc(xyz_last, h_idx, 9)
    hnc_abstraction.append(is_hnc)
    if is_hnc:
        continue

    abstraction_type.append(find_abstracted_h(xyz_last, h_idx, h_type, 8))
...
# plt.savefig("../images/ethane_cn_pm6.png", dpi=200)
plt.show()


# Saving Pruned PM6 data
f = h5py.File("../data_sets/ethane_cn_pm6.hdf5", "w")
