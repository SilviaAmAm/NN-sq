...
data = np.load("../training/methane_isopentane_2/sorted_predictions.npz")
...
# # plt.savefig("../images/methane_pred_2.png", dpi=200)
# plt.show()
...
# subax1.tick_params(axis='x', labelsize=20)
# subax1.tick_params(axis='y', labelsize=20)
# # plt.savefig("../images/isopentane_pred_2.png", dpi=200)
# plt.show()
...
# # plt.savefig("../images/squal_pred_2.png", dpi=200)
# plt.show()