...
part_ax_1.legend()
# part_fig_1.savefig("../images/acsf_distances.png", dpi=200)
plt.show()
...
bins_man = np.arange(0, max(diff_man_methane), 0.05)
...
part_ax_2.legend()
# part_fig_2.savefig("../images/acsf_distances.png", dpi=200)
plt.show()