...
n_max_methane = int(tot_n_samples[-1]*(1-0.3333333))
n_max_isopent = int(tot_n_samples[-1]*0.33333333)
...
idx_train_methane = idx_train_methane[:n_max_methane]

print("The maximum number of methane samples is: %i (train)" % (len(idx_train_methane)))
...
idx_train_isopentane = idx_train_isopentane[:n_max_isopent]

print("The maximum number of isopentane samples is: %i (train)" % (len(idx_train_isopentane)))
...
for samples in tot_n_samples:
    ...
    idx_training = idx_training[:samples]
